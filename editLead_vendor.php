...
<!-- <div class="container mx-auto px-4">
    <div class="-mx-4 border-b-2 flex flex-wrap h-auto">
        <div class="pl-4 pr-0 w-auto">
            <img src="images/Logo-Image.png" class="w-1/2">
        </div>
        <div class="mt-0 mx-auto pb-10 pt-0 px-4 text-right w-6/12">
            <div class="border-b-2">
                <h2 class="mt-14 text-3xl w-7/12"><b class="text-LogoGold-500">$LBL_VENDOR</b></h2>
            </div>
            <div>
                <p><b class="h-auto mr-3 w-auto">FORMAL QUOTE - ID #&nbsp; $lead_opertunityid_c</b></p>
            </div>
        </div>
    </div>
</div> -->
<div class="container h-auto mt-8 mx-auto pt-8 px-4 shadow-2xl">
    <div class="-mx-4 flex flex-wrap">
        <div class="pl-0 text-left w-full md:w-1/2">
            <div class="mx-auto">
                <h1 class="fw-bolder me-auto ms-auto mt-5 text-primary text-center text-start text-uppercase titleSize">TRIP DETAILS</h1>
                <h2 class="font-bold ml-24 pt-6 text-gray-400">Event Date :&nbsp;<?php echo $opportunities[0]['eventdate_c'] ?></h2>
                <h2 class="font-bold ml-24 pt-6 text-gray-400">Event Type :&nbsp;<?php echo $opportunities[0]['eventtype_c'] ?></h2>
                <h2 class="font-bold ml-24 pt-6 text-gray-400">Pickup Time : <?php echo $opportunities[0]['pickuptime_c'] ?></h2>
                <h2 class="font-bold ml-24 pt-6 text-gray-400">Hours : <?php echo $opportunities[0]['servicelength_c'] ?> Hours</h2>
                <h2 class="font-bold ml-24 pt-6 text-gray-400">Passenger Count : <?php echo $opportunities[0]['numberofpassengers_c'] ?><br><br><br></h2>
            </div>
        </div>
    </div>
</div>
<div class="flex flex-no-wrap items-center max-w-screen-2xl mx-auto pb-0 pt-10">
    ...
    <div class="px-10 w-auto">
        <h2 class="font-semibold text-2xl uppercase f36"><b class="text-4xl text-LogoGold-500 text-dfca8b-500 f36">Vehicle Requested</b></h2>
    </div>
    <div class="bg-gray-500 flex-grow h-px max-w-full"></div>
</div>
<div class="container mt-10 mx-auto px-4 shadow-2xl">
    <div>
        <h2 class="font-normal text-center text-xl uppercase f20" style="font-weight:400!important;">Client is looking to book the following vehicle.</h2>
    </div>
    <div class="-mx-4 flex flex-wrap pt-10 row">
        <div class="px-4 w-full sm:w-1 md:w-1/2">
            ...
            <div class="imgDiv">
                ...
                foreach ($vehicleData as $key => $value) {
                    ...
                    if (isset($opportunities[0]['vechiles_name_c']) && isset($vehicle[$key]) && $opportunities[0]['vechiles_name_c'] == $vehicle[$key]) {
                        ...
                        echo '<img src="./vehicles/' . $firstImage . '" class="h-auto mx-auto w-auto">';
            ...
            <p class="mx-auto pt-10 w-80 f16">Vehicle Type :&nbsp;&nbsp;<?php echo $single_vehicle_data['name']; ?></p>
            <p class="mx-auto pt-0 w-80 f16">Vehicle Year :&nbsp; &nbsp;<?php echo $single_vehicle_data['vehicle_year'] ?></p>
            <p class="mx-auto pt-0 w-80 f16">Vehicle Make :&nbsp;&nbsp;<?php echo $single_vehicle_data['vehicle_make'] ?></p>
            <p class="mx-auto pt-0 w-80 f16">Vehicle Model :&nbsp;&nbsp;<?php echo $single_vehicle_data['vehicle_model'] ?></p>
            <div class="mt-5 text-center">
                <p class="font-bold text-red-500 uppercase f14">If this vehicle is booked, </p>
                <p class="text-gray-400 uppercase f14">Please select or add a new vehicle that would be available.</p>
            </div>
            <div class="mt-5 text-center">

                <form method="POST" action="./updateLead.php" id="vehicleForm">
                    ...
                    <select name="SelectVehicle" id="SelectVehicle" class="w-3/5 bd-1" multiple="multiple">
                        ...
                        foreach ($vehicleData as $key => $vehicle) {
                            ...
                            if (isset($vehicle['name']) && !empty($vehicle['name'])) {
                                ...
                                echo '<option value="' . $key . '" data-pg-name="' . $vehicle['name'] . '" class="bg-yellow-200 f14 pd-5 ' . $check . '">' . $vehicle['name'] . '</option></a>';
                            }
                        }
        ...
        <div class="px-4 w-full sm:w-1 md:w-1/2">
            <div class="mapouter">
                ...
                // $first_word = str_replace(" ","+",$first_city);
                // $second_word = str_replace(" ","+", $second_city);
...
<div class="gmap_canvas">
    ...
    src="<?php  echo 'https://maps.google.com/maps?q=' . $first_word . 'to=' . $second_word . '&t=&z=10&ie=UTF8&iwloc=&output=embed'; ?>" 
                 
                    frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                        <a href="https://www.analarmclock.com/"></a><br><a href="https://www.onclock.net/"></a>
                        <br>
                    <style>
                        .mapouter {
                            position: relative;
    ...
    <div class="my-10">
        <div class="mt-16 mx-auto w-10/12">
            <h3 class="font-bold italic text-3xl text-LogoBlue-500 uppercase">Pickup</h3>
            <pre class="font-extrabold mt-5 text-gray-400"><?php echo $opportunities[0]['pickuplocation_c'] ?></pre>
            <h3 class="font-bold italic mt-10 text-3xl text-LogoBlue-500 uppercase">Destination</h3>
            <pre class="font-extrabold mt-5 text-gray-400"><?php echo $opportunities[0]['location_c'] ?></pre>
            <h3 class="font-bold italic mt-10 text-3xl text-LogoBlue-500 uppercase">Client Itinerary</h3>
            <pre class="font-extrabold mt-5 text-gray-400"><?php echo $opportunities[0]['clientnotes_c'] ?></pre>
        </div>
        <div><br><br><br><br>
        </div>
    </div>
...
<div class="border-2 mx-auto my-10 shadow-2xl text-left w-8/12">
    <div class="mx-auto">
        ...
        <h2 class="font-bold ml-10 pt-6 text-2xl text-gray-400 f24">+ Fuel : $<?php echo $opportunities[0]['fuel_c'] ?></h2>
        <h2 class="font-bold ml-10 pt-6 text-2xl text-gray-400 f24">+ Mileage : $<?php echo $opportunities[0]['mileage_c'] ?></h2>
        <h2 class="font-bold ml-10 pt-6 text-2xl text-gray-400 f24">+ Gratuity : $<?php echo $opportunities[0]['gratuity_c'] ?></h2>
        <h2 class="font-bold ml-10 pt-6 text-2xl text-gray-900 f24">Subtotal :&nbsp;$<?php echo $opportunities[0]['quoted_c'] ?></h2>
...
"><button class="animate-bounce bg-65d5e2-500 bg-LogoGold-500 border-2 border-65d5e2-500 border-gray-500 font-extrabold leading-normal mt-5 mx-auto px-10 py-2 rounded-full shadow-gray-500 shadow-md text-3xl text-center text-gray-50 uppercase f30" name="Reserve Now" type="button">Send As Is</button></a>
        ...
        <div class="shadow-2xl">
            ...
            <div class="mb-10 mt-5">
                <input name="vnd_updated_pricing" placeholder="$ New Pricing" class="bg-yellow-100 f18 italic text-xl w-auto newPricing" style="color:#000!important;">
            </div>
