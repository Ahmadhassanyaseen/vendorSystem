                            ...
                            <div class="ipt_uif_column ipt_uif_column_third ipt_uif_conditional ipt_fsqm_container_feedback_small" id="ipt_fsqm_form_52_freetype_8">
                                <div class="ipt_uif_column_inner side_margin">
                                    <div class="ipt_uif_question ipt_uif_question_vertical ipt_uif_question_full">
                                        ...
                                        <div class="ipt_uif_question_content">
                                            <div class="input-field has-icon"> <input class="ipt_uif_text" name="base_min_hours" id="base_min_hours" type="text" placeholder="Enter Minimum Hours" title="Enter Minimum Hours" value="<?php echo number_format($vehicle_object['base_min_hours'], 0, '.', ','); ?>" required>
                                                <i title="" class="ipticm prefix" data-ipt-icomoon="&#xe082;"></i>
                                            </div>
                                            <div class="clear-both"></div>
                                        </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="ipt_uif_matrix_div_cell">
                                                                    <div class="input-field">
                                                                        <input class="ipt_uif_matrix_text check_me ipt_uif_text" name="min_hours_monday" id="min_hours_monday" type="text" value="<?php echo number_format($vehicle_object['min_hours_monday'], 0, '.', ','); ?>" placeholder="Hours" title="Minimum number of hours for Monday">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="ipt_uif_matrix_div_cell">
                                                                    <div class="input-field">
                                                                        <input class="ipt_uif_matrix_text check_me ipt_uif_text" name="min_hours_tuesday" id="min_hours_tuesday" type="text" value="<?php echo number_format($vehicle_object['min_hours_tuesday'], 0, '.', ','); ?>" placeholder="Hours" title="Minimum number of hours for Tuesday">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="ipt_uif_matrix_div_cell">
                                                                    <div class="input-field">
                                                                        <input class="ipt_uif_matrix_text check_me ipt_uif_text" name="min_hours_wednesday" id="min_hours_wednesday" type="text" value="<?php echo number_format($vehicle_object['min_hours_wednesday'], 0, '.', ','); ?>" placeholder="Hours" title="Minimum number of hours for Wednesday">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="ipt_uif_matrix_div_cell">
                                                                    <div class="input-field">
                                                                        <input class="ipt_uif_matrix_text check_me ipt_uif_text" name="min_hours_thursday" id="min_hours_thursday" type="text" value="<?php echo number_format($vehicle_object['min_hours_thursday'], 0, '.', ','); ?>" placeholder="Hours" title="Minimum number of hours for Thursday">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="ipt_uif_matrix_div_cell">
                                                                    <div class="input-field">
                                                                        <input class="ipt_uif_matrix_text check_me ipt_uif_text" name="min_hours_friday" id="min_hours_friday" type="text" value="<?php echo number_format($vehicle_object['min_hours_friday'], 0, '.', ','); ?>" placeholder="Hours" title="Minimum number of hours for Friday">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="ipt_uif_matrix_div_cell">
                                                                    <div class="input-field">
                                                                        <input class="ipt_uif_matrix_text check_me ipt_uif_text" name="min_hours_saturday" id="min_hours_saturday" type="text" value="<?php echo number_format($vehicle_object['min_hours_saturday'], 0, '.', ','); ?>" placeholder="Hours" title="Minimum number of hours for Saturday">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="ipt_uif_matrix_div_cell">
                                                                    <div class="input-field">
                                                                        <input class="ipt_uif_matrix_text check_me ipt_uif_text" name="min_hours_sunday" id="min_hours_sunday" type="text" value="<?php echo number_format($vehicle_object['min_hours_sunday'], 0, '.', ','); ?>" placeholder="Hours" title="Minimum number of hours for Sunday">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
