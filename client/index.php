...
(min-width: 2400px) 31vw">
    ...
    <?php if (!empty($leadQuotes[0]) && count($leadQuotes) > 0 && isset($leadQuotes[0]) && $leadQuotes[0]) { ?>
        <div class="container h-auto mt-8 mx-auto  px-4 ">
            <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
                    ...
                    <?php
                    if ($lead[0]['sent_quote_id_c'] != null && $lead[0]['sent_quote_id_c'] !== "") {
            ...
            <div id="default-tab-content">
                ...
                ?>
                        <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="<?php echo $id; ?>" role="tabpanel" aria-labelledby="<?php echo $id; ?>-tab">
                            ...
                            <div class="container mt-10 mx-auto px-4 shadow-2xl">
                                <div class="-mx-4 flex ">
                                    ...
                                    <div class="mx-auto shadow-2xl text-center px-4 w-full md:w-1/2">
                                        <h2 class="font-bold mx-auto pt-6 text-2xl text-gray-900">Hourly Rate: @ $ <?php echo number_format($quotedPrice/$lead[0]['servicelength_c'],2); ?> Per Hour</h2>
                            ...
                            <?php if ($quote_data['data']['quote_status_c'] == "Pending" && $lead[0]['status'] == "New") { ?>
