                        ...
                        <tbody>
                            ...
                            foreach ($subArrays[$loopControl] as $data) {
                                ...
                                if ($lead && isset($lead)) {
                                    ...
                                    if (isset($lead[0]['location_c']) && $lead[0]['location_c']) {
                                        $location = $lead[0]['location_c'];
                                    } else {
                                        $location = "";
                                    }
                ...
                <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4" aria-label="Table navigation">
                    ...
                    <ul class="inline-flex items-stretch -space-x-px">
                        <li>
                            ...
                            ?>
                            <a href="./test.php?page=<?php echo $pre?>" class="flex items-center justify-center h-full py-1.5 px-3 ml-0 text-gray-500 bg-white rounded-l-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                        ...
                        foreach ($subArrays as $data) {
                            echo ' <li>
                            <a href="./test.php?page=' . $i . '" class="flex items-center justify-center text-sm py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">' . $i . '</a>
                        </li>';
                            $i++;
                        }
