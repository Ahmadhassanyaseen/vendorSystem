...
{	
	...
	public function phpcaptcha($textColor,$backgroundColor,$imgWidth,$imgHeight,$noiceLines=0,$noiceDots=0,$noiceColor='#008CBA')
	{	
		/* Settings */
		$text=$this->random();
	...
	/*for random string*/
	protected function random($characters=7,$letters = '023456789abcdefghijkmnpqrtuvwxyz'){
		$str='';
